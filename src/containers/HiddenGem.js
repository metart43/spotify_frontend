...
class HiddenGem extends React.Component {
  ...
  cancel(e) {
    console.log(e);
    message.error('Save it for later!');
  }
      ...
      <React.Fragment>
        ...
        <Row type="flex" justify="space-around" align="middle">
          ...
          <Col span={8}><Title level={3}>{this.props.hiddenGem? this.props.hiddenGem.name : console.log('no name')}
            <Popconfirm title="Do you want to scrap you pile?" onConfirm={() => {this.props.deleteHiddenGem(this.props.hiddenGem); message.success('You have scraped your pile')}} onCancel={this.cancel} okText="Yes" cancelText="No">
